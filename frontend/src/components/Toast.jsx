...
const Toast = ({ success, message }) => {
  ...
  if (!hideMe)
    return (
      <div
        className={`bg-white text-base text-slate-900 px-4 py-2 rounded-md flex text-center items-center justify-center w-full relative top-0 mr-auto mb-4 left-0 gap-4 transition first-letter:uppercase ${
