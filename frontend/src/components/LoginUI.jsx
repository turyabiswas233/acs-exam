...
function Login() {
  ...
  return (
    <div className="w-full h-[100dvh] flex justify-center items-center relative">
      ...
      {user != null ? (
        <div className="modal-box grid bg-blue-600 place-items-center">
          <h2 className="text-white text-center w-full rounded-lg text-xl">
            Logged in as <span className="text-blue-200/80">{user?.email}</span>
          </h2>
          <Link to={"/"}>
